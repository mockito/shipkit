...
class DefaultReleaseNotesGeneratorTest extends Specification {
    ...
    def "gets release notes data"() {
        ...
        def gen = ReleaseNotesGenerators.releaseNotesGenerator(rootDir, "mockito/mockito-release-tools-example", authToken, new IgnoredCommit(["[ci skip]"]))
        ...
        def results = ReleaseNotesFormatters.notableFormatter(
                "Release notes:\n\n", "http://release-notes",
                "https://github.com/mockito/mockito-release-tools-example/compare/{0}...{1}")
...
Authors: [1](http://release-notes), commits: [20](https://github.com/mockito/mockito-release-tools-example/compare/v0.7.1...v0.10.0), improvements: [3](http://release-notes).
...
Authors: [1](http://release-notes), commits: [61](https://github.com/mockito/mockito-release-tools-example/compare/v0.0.1...v0.7.1), improvements: [2](http://release-notes).
