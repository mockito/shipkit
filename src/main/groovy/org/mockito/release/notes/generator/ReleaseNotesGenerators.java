...
public class ReleaseNotesGenerators {
     ...
     * @param commitApprover responsible for accepting commits that will be included in release notes
     */
    public static ReleaseNotesGenerator releaseNotesGenerator(File workDir, String gitHubRepository, String readOnlyAuthToken, Predicate<Commit> commitApprover) {
        ProcessRunner processRunner = Exec.getProcessRunner(workDir);
        ContributionsProvider contributionsProvider = Vcs.getContributionsProvider(processRunner, commitApprover);
