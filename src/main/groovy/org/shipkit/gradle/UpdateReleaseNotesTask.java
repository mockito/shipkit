...
public class UpdateReleaseNotesTask extends DefaultTask {
    ...
    private String header = "This release notes was automatically generated by [shipkit](http://shipkit.org/)";

    private IncrementalNotesGenerator incrementalNotesGenerator = new IncrementalNotesGenerator();
    private HeaderProvider headerProvider = new HeaderProvider();
    private HeaderRemover headerRemover = new HeaderRemover();
    ...
    public void updateReleaseNotes() {
        ...
        if (previewMode){
            ...
            headerRemover.removeHeaderIfExist(getReleaseNotesFile());
    ...
    @ExposedForTesting
    void setHeaderRemover(HeaderRemover headerRemover){
        this.headerRemover = headerRemover;
    }
    ...
    class IncrementalNotesGenerator {
        public String generateNewContent() {
            ...
            String headerMessage = headerProvider.getHeader(UpdateReleaseNotesTask.this.header);
            ...
            String notes = ReleaseNotesFormatters.detailedFormatter(
                headerMessage,"", gitHubLabelMapping, vcsCommitTemplate, publicationRepository, contributorsMap, emphasizeVersion)
