...
public class PluginDiscoveryTask extends DefaultTask {
    ...
    private static Logger LOG = Logging.getLogger(PluginDiscoveryTask.class);

    @TaskAction
    public void discover() {
        PluginBundleExtension extension = getProject().getExtensions().findByType(PluginBundleExtension.class);

        Set<File> pluginPropertyFiles = PluginUtil.discoverGradlePluginPropertyFiles(getProject());
