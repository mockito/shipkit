...
class GradlePortalReleasePluginTest extends PluginSpecification {
    ...
    def "configures tasks with publication repo"() {
        ...
        contrib.execCommands*.commandLine.toString() == "[[./gradlew, releaseNeeded, performRelease, releaseCleanUp, -PdryRun, -x, gitPush, -x, updateReleaseNotesOnGitHub, -x, publishPlugins]]"
    }
}
