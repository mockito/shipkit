...
public class CreateDependencyInfoFile {
    ...
    public void createDependencyInfoFile(CreateDependencyInfoFileTask task) {
        JsonObject result = new JsonObject(new LinkedHashMap<String, Object>()); // linkedHashMap to keep the order
        result.put("description", DESCRIPTION);

        JsonArray dependencies = new JsonArray(new ArrayList<Object>()); //arrayList to keep the order
    ...
    private void addResolvedDependency(CreateDependencyInfoFileTask task, JsonArray dependencies, ResolvedArtifact artifact) {
        JsonObject dependency = new JsonObject(new LinkedHashMap<String, Object>()); // linkedHashMap to keep the order
    ...
    private void addSelfResolvingDependency(JsonArray dependencies, SelfResolvingDependency selfResolvingDependency) {
        JsonObject selfDependency = new JsonObject(new LinkedHashMap<String, Object>()); // linkedHashMap to keep the order
